...
const steps = [
  {
    id: "1",
    name: "AI Guide",
    title: "Персональный AI-трип-планнер",
    description:
      "Умный ассистент подбирает маршруты под стиль путешествия, выдаёт готовые планы на 1–5 дней, учитывает локацию, интересы и формат поездки.",
  },
  {
    id: "2",
    name: "Interactive Map",
    title: "Интерактивная карта с офлайн-режимом",
    description:
      "Маршруты, достопримечательности, тропы, сервисы, трекинг GPS и сохранение точек. Работает даже без интернета в горах и удалённых зонах.",
  },
  {
    id: "3",
    name: "Safety",
    title: "Модуль безопасности и SOS-система",
    description:
      "Экстренный вызов, передача геолокации, справочник больниц, полиции и посольств, предупреждения о погоде и рисках. Интеграция с SafeTravel.",
  },
  {
    id: "4",
    name: "Booking",
    title: "Бронирования и локальные гиды",
    description:
      "Отели, турбазы, экскурсии, трансферы и авторские маршруты от местных гидов. Сравнение цен, отзывы, быстрые резервы.",
  },
] as const
