...
export const NavbarButton = ({
  ...
  const baseStyles =
    "tracking-[-0.07em] px-4 py-2 rounded-md bg-white button bg-white text-black text-sm relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
